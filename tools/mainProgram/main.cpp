...
void npcDataInterfaceTest1() {
   npcDataInterface npcInterface{"midgaard.yml"};
   npcInterface.loadAll();
   npcInterface.printAll();
}

void dataEmitterTest1() {
   dataEmitter emit{"example"};
   emit.startEmittingToYamlFile("Newfound");
}

void objDataInterfaceTest1() {
   objDataInterface objInterface{"midgaard.yml"};
   objInterface.loadAll();
   objInterface.printAll();
}

void spellDataInterfaceTest1() {
